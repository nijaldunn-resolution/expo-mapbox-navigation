...
typedef NS_ENUM(NSInteger, MBNNSapaType);
...
- (nonnull instancetype)initWithHeading:(double)heading
                             ...
                             speedLimit:(nullable NSNumber *)speedLimit
                                  speed:(double)speed
                          freeFlowSpeed:(nullable NSNumber *)freeFlowSpeed
                   constrainedFlowSpeed:(nullable NSNumber *)constrainedFlowSpeed
                                   ramp:(BOOL)ramp
...
/**
 * The Edge's free flow speed (m/s) when there is no traffic.
 * Not set if unknown.
 */
@property (nonatomic, readonly, nullable) NSNumber *freeFlowSpeed;

/**
 * The Edge's constrained flow speed (m/s) when there is traffic.
 * Not set if unknown.
 */
@property (nonatomic, readonly, nullable) NSNumber *constrainedFlowSpeed;
...
/** Is the edge a ferry? */
@property (nonatomic, readonly) BOOL ferry;
...
/**
 * WARNING: This API is not intended for public usage. It can be deleted or changed without any notice.
 * Returns whether the edge a part of service area or rest area or none
 */
