...
- (nonnull instancetype)initWithCurrentLocationRadius:(uint32_t)currentLocationRadius
                                    routeBufferRadius:(uint32_t)routeBufferRadius
                            destinationLocationRadius:(uint32_t)destinationLocationRadius
              loadPredictiveCacheForAlternativeRoutes:(BOOL)loadPredictiveCacheForAlternativeRoutes;
...
/**  Whether alternative routes will be loaded for predictive cache */
@property (nonatomic, readonly) BOOL loadPredictiveCacheForAlternativeRoutes;
